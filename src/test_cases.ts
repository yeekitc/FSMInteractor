...
// test do not change.
function test1() {
	let r1 : Region = new Region("r1", "./images/one.png",   0,0,50,77);
	let r2 : Region = new Region("r2", "./images/two.png",   20,50, -1,50);
	let r3 : Region = new Region("r3", "./images/three.png", 40,100, 77,30);
	let r4 : Region = new Region("r4", "./images/four.png",  60,150);
	let r5 : Region = new Region("r5",  "",                  80,200, 77, 77);
	...
	const fsm : FSM = new FSM([r1,r2,r3,r4,r5], [st1]);
